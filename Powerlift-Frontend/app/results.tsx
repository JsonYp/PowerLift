...
type ResultsParams = {
  ...
  bodyWeight?: string;
  weightUsed?: string;
  workoutDate?: string; // Date when the workout was performed
...
export default function ResultsScreen() {
    ...
    if (params.scores) {
      try {
        ...
        if (user && analysisId && parsedScores.overall) {
          // Use the provided workout date or fall back to today's date
          const workoutDate = params.workoutDate || new Date().toISOString().split('T')[0];
  ...
  }, [params.scores, analysisId, user, addProgressEntry, exerciseType, weightUsed, bodyWeight, params.workoutDate]);
